        ...
        <div className={TI_CLASSES.rightContainer}>
          ...
          <div className="relative">
            <button onClick={(e) => { e.stopPropagation()
               setShowMenu(prev => !prev) }} className={TI_CLASSES.menuButton}>
                <MoreVertical className='w-4 h-4 sm:w-5 sm:h-5' />
            </button>

            {showMenu && (
              <div className={`${TI_CLASSES.menuDropdown} absolute right-0 mt-2 z-50`} onClick={(e) => e.stopPropagation()}>
          ...
          <div>
            ...
            <div className={TI_CLASSES.createdRow}> <Clock className='w-3 h-3 sm:w-3.5 sm:h-3.5' />
              {task.createdAt
