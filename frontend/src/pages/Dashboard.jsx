...
import { ADD_BUTTON, HEADER, STATS, STATS_GRID, WRAPPER, STAT_CARD, ICON_WRAPPER, VALUE_CLASS,LABEL_CLASS,
FILTER_WRAPPER,FILTER_LABELS,SELECT_CLASSES,FILTER_OPTIONS,TABS_WRAPPER,TAB_BASE,TAB_ACTIVE,TAB_INACTIVE,EMPTY_STATE} from '../assets/dummy'
  ...
  return (
    <div className={WRAPPER}>
      ...
      <div className="space-y-6">
        ...
        <div className="space-y-4">
          {filteredTasks.length === 0 ? (
            ...
            filteredTasks.map((task) => (
              <TaskItem key={task._id || task.id} task={task} onRefresh={refreshTasks} showCompleteCheckbox
                onEdit={() => {
        ...
        <div
          onClick={() => setShowModal(true)}
          className="hidden md:flex items-center justify-center p-4 border-2 border-dashed border-purple-200 rounded-xl
          hover:border-purple-400 bg-purple-50/50 cursor-pointer transition-colors"
        >
      ...
      tasToEdit={selectedTask} onSave={handleTaskSave}/>
    </div>
  )
}
